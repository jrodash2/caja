...
class Carrera (models.Model):
      nombre = models.CharField(max_length=200, verbose_name='Nombre')
      ciclos = models.ManyToManyField(Ciclo,  verbose_name='Ciclos')
      creacion = models.DateTimeField(auto_now_add=True, verbose_name='Fecha de Creación')
      actualizacion = models.DateTimeField(auto_now_add=True, verbose_name='Fecha de Modificación' )
      activo = models.BooleanField(default=True, verbose_name='Activo')
...
class Grado (models.Model):
      ...
      creacion = models.DateTimeField(auto_now_add=True, verbose_name='Fecha de Creación')
      llama = models.CharField(max_length=200, verbose_name='Nombre')
      actualizacion = models.DateTimeField(auto_now_add=True, verbose_name='Fecha de Modificación' )
      activo = models.BooleanField(default=True, verbose_name='Activo')
...
class Docente(models.Model):
      nombre = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='Nombre')
...
class Calificacion(models.Model):
      ...
      estudiante = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='Estudiante')
      activo = models.BooleanField(default=True, verbose_name='Activo')
      ciclos = models.ManyToManyField(Ciclo,  verbose_name='Ciclos')
